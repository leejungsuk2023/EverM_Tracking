              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-slate-100 bg-slate-50">
                    ...
                    <th className="text-left px-4 py-3 font-semibold text-slate-600 hidden sm:table-cell">{t('patients.table.surgery')}</th>
                    <th className="text-left px-4 py-3 font-semibold text-slate-600 hidden md:table-cell">{t('patients.table.date')}</th>
                    <th className="text-left px-4 py-3 font-semibold text-slate-600">{t('patients.table.stage')}</th>
                    <th className="text-center px-4 py-3 font-semibold text-slate-600 hidden sm:table-cell">{t('patients.table.docs')}</th>
                    <th className="text-left px-4 py-3 font-semibold text-slate-600 hidden md:table-cell">{t('patients.table.payment')}</th>
                  </tr>
                </thead>
                <tbody>
                  {filtered.length === 0 ? (
                    ...
                    filtered.map(patient => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-4 py-3 text-slate-700 hidden md:table-cell">{patient.surgery_date}</td>
                          <td className="px-4 py-3">
